...
The Game Project 7 - Adding Sounds
...
function startGame() {
  ...
  collectables = [
    { pos_x: 350, pos_y: 280, size: 0.5, isFound: false },
    { pos_x: 1350, pos_y: 350, size: 0.5, isFound: false },
    { pos_x: 1025, pos_y: 250, size: 0.5, isFound: false },
  ]
  ...
  mountains = [
    ...
    { pos_x: 900, pos_y: floorPos_y, width: 200, height: 600 },
  ...
  platforms.push(createPlatforms(740, 290, 200))
  platforms.push(createPlatforms(950, 230, 200))

  enemies = []
  //PUSHING enemy into enemies
  enemies.push(new Enemy(400, floorPos_y, 200))
  enemies.push(new Enemy(740, 290, 200))
  enemies.push(new Enemy(950, 230, 200))
}
...
//Constructor Function: The function is "itself" an Objects
